...
int PerfRecord<INST, RESERVE, DECLARE,  ANON>::init_perf(const char* desc)
{
    ...
    circles_per_ns_[PERF_COUNTER_RDTSC_BTB] = circles_per_ns_[PERF_COUNTER_RDTSC];
    ...
    circles_per_ns_[PERF_COUNTER_RDTSC_MFENCE_BTB] = circles_per_ns_[PERF_COUNTER_RDTSC];
