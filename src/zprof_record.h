...
public:
    ...
    int serialize(int entry_idx, int depth, ProfSerializeBuffer& buffer, std::function<void(const ProfSerializeBuffer& buffer)> call_log = NULL);
    ProfSerializeBuffer serialize(int entry_idx, std::function<void(const ProfSerializeBuffer& buffer)> call_log = NULL);
    int serialize(std::function<void(const ProfSerializeBuffer& buffer)> call_log);
...
template<int INST, int RESERVE, int DECLARE, int ANON>
int ProfRecord<INST, RESERVE, DECLARE,  ANON>::serialize(int entry_idx, int depth, ProfSerializeBuffer& buffer, std::function<void(const ProfSerializeBuffer& buffer)> call_log)
{
...
template<int INST, int RESERVE, int DECLARE, int ANON>
ProfSerializeBuffer ProfRecord<INST, RESERVE, DECLARE,  ANON>::serialize(int entry_idx, std::function<void(const ProfSerializeBuffer& buffer)> call_log)
{
...
template<int INST, int RESERVE, int DECLARE, int ANON>
int ProfRecord<INST, RESERVE, DECLARE, ANON>::serialize(std::function<void(const ProfSerializeBuffer& buffer)> call_log)
{
    ProfCounter<> counter;
    counter.start();
