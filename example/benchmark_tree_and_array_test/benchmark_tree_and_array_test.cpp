...
int main(int argc, char *argv[])
{
    ...
    zhash_map<u64, EntityCell, 1048576, FastHash> * entity_hash_map_ptr = new zhash_map<u64, EntityCell, 1048576, FastHash>();
    zhash_map<u64, EntityCell, 1048576, FastHash>& entity_hash_map = *entity_hash_map_ptr;
