...
int main(int argc, char* argv[])
{
    ...
    {
        //注册ID  
        PROF_REGIST_NODE(scene_2_id, "scene 2", zprof::kClockFenceRDTSC, false, false);
    ...
    if (true)
    {
        ...
        //带count写入 
        PROF_RECORD_CPU_WRAP(scene_6_tmp_id, 1000, cost.cost(), zprof::kRecordLevelNormal);
    ...
    if (true)
    {
        PROF_REGIST_NODE(scene_8_resident_id, "scene_8_resident_id", zprof::kClockFenceRDTSC, true, false);
        PROF_REGIST_NODE(scene_8_unresident_id, "scene_8_resident_id", zprof::kClockFenceRDTSC, false, false);
        ...
        //写入记录信息  
        PROF_RECORD_CPU_WRAP(scene_8_resident_id, 1000, cost.cost(), zprof::kRecordLevelNormal);
        PROF_RECORD_CPU_WRAP(scene_8_unresident_id, 1000, cost.cost(), zprof::kRecordLevelNormal);
