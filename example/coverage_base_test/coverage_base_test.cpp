...
int main(int argc, char *argv[])
{
    ...
    if (true)
    {
        ...
        START_PROF_COUNTER(PROF_COUNTER_CHRONO);
        START_PROF_COUNTER(PROF_COUNTER_CHRONO_STEADY);
        START_PROF_COUNTER(PROF_COUNTER_CHRONO_SYS);
        ...
        for (int i = 0; i < sleep_count; i++)
        {
            ...
            RESTART_PROF_COUNTER(PROF_COUNTER_CHRONO);
            RESTART_PROF_COUNTER(PROF_COUNTER_CHRONO_STEADY);
            RESTART_PROF_COUNTER(PROF_COUNTER_CHRONO_SYS);
            ...
            RECORD_PROF_COUNTER(PROF_COUNTER_CHRONO);
            RECORD_PROF_COUNTER(PROF_COUNTER_CHRONO_STEADY);
            RECORD_PROF_COUNTER(PROF_COUNTER_CHRONO_SYS);
