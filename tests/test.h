...
enum MyEnum
{
    ENUM_PERF_TEST = PERF_DECLARE_TRACK_BEGIN,
    ENUM_BAT_ALLOC_FREE,
    ENUM_ONE_TICK,
    ENUM_ENTRY,
    ENUM_ALLOC_SUM,
...
inline void regist_perf()
{
    ...
    PERF_FAST_REGIST_TRACK(ENUM_MERGE_ROOT);
    PERF_FAST_REGIST_TRACK(ENUM_MERGE_PARRENT);
    PERF_FAST_REGIST_TRACK(ENUM_MERGE_CHILD1);
    PERF_FAST_REGIST_TRACK(ENUM_MERGE_CHILD2);
    ...
    PERF_BIND_CHILD(ENUM_MERGE_ROOT, ENUM_MERGE_PARRENT);
    PERF_BIND_CHILD(ENUM_MERGE_PARRENT, ENUM_MERGE_CHILD1);
    PERF_BIND_CHILD(ENUM_MERGE_PARRENT, ENUM_MERGE_CHILD2);

    PERF_BIND_MERGE(ENUM_MERGE_CHILD1, ENUM_MERGE_PARRENT);
    PERF_BIND_MERGE(ENUM_MERGE_CHILD2, ENUM_MERGE_PARRENT);
    PERF_BIND_MERGE(ENUM_MERGE_PARRENT, ENUM_MERGE_ROOT);
